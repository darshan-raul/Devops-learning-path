...
https://cloudpacket.net/media/DNS-CheatSheet-V1.02.pdf
https://docs.apnscp.com/admin/dns-in-a-nutshell/
https://dzone.com/refcardz/dns?chapter=1
* What is HTTP?
...
- Contrary to popular belief, it is not necessary that each entry in the UID field be unique. However, non-unique UIDs can cause security problems
